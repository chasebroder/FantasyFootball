...
import draftTool.model.*;
import draftTool.view.draftController;
import draftTool.view.draftHubController;
...
public class MainApp extends Application {
    ...
    public static void showDraft() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(MainApp.class.getResource("view/draft.fxml"));
    ...
    public static void showDraftHub(League l) {
    	try {
            ...
            loader.setLocation(MainApp.class.getResource("view/draftHub.fxml"));
